...
def run_cli(csv_path: str, n_sims: int, output_dir: str) -> None:
...
def main():
    ...
    parser.add_argument("--csv", default="data/examples/EURUSD_5M_sample.csv", help="path to market data CSV (--cli mode)")

...
<head>
<meta charset="utf-8">
<title>T58 Quant Algo Backtester — Iterative Refinement: {strategy_name}</title>
<style>
  :root {{
...
<div class="masthead">
  ...
  <div class="titles">
    <h1>Quant Algo Backtester — Iterative Refinement Report</h1>
